...
class RegisterWindow(QDialog):
    ...
    def __init__(self, db: Database, auth: AuthService, parent=None):
        ...
        self._password.setPlaceholderText("密码（至少 6 位）")
        ...
        back_btn.setStyleSheet("color: #1E5BA8;")
    ...
    def _submit(self):
        ...
        ok, msg = self._auth.register(username, email, password, role="user")
        if ok:
